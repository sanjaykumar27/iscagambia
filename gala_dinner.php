    ...
    <div class="bg-white border border-2 border-dark card-body rounded-3 shadow-lg">
      ...
      <form action="dmxConnect/api/booking.php" type="post" class=" border-top" id="formRegisterDinner" is="dmx-serverconnect-form" method="post" dmx-on:success="notif.success('Dinner Registration Successful!');formRegisterDinner.reset()">
        ...
        <div class="row my-3">
          <div class="col-12 w-100">
            <div class="card border-0">
              ...
              <p class="text-center my-4 fs-4 fw-bolder">PLATINUM</p>
                ...
                <div class="d-flex justify-content-between" is="dmx-repeat" id="repeatPlatinum1" dmx-bind:repeat="6">
                  ...
                  <div class="card border shadow-sm rounded-circle custom-circle ms-3 mt-3" style="width:80px;height:80px">
                    <div class="card-body" is="dmx-repeat" id="repeatPlatinum1Childs" dmx-bind:repeat="10">
                      ...
                      <div class="tick" dmx-bind:style="transform: rotate({{$index * 360/10}}deg) translate(58px);" dmx-on:click="arrPlatinum.addUniq(varPlatinum1.value)"><i class="fas fa-chair fa-rotate-90" dmx-class:text-success="arrPlatinum.items.contains(varPlatinum1.value)"></i></div>
                    </div>
                  </div>
                </div>
                <div class="d-flex mt-5 pt-2 justify-content-between" is="dmx-repeat" id="repeatPlatinum2" dmx-bind:repeat="6">
                  ...
                  <div class="card border shadow-sm rounded-circle custom-circle ms-3 mt-3" style="width:80px;height:80px">
                    <div class="card-body " is="dmx-repeat" id="repeatPlatinum2Childs" dmx-bind:repeat="10">
                      ...
                      <div class="tick" dmx-bind:style="transform: rotate({{$index * 360/10}}deg) translate(58px);" dmx-on:click="arrPlatinum.addUniq(varPlatinum2.value)"><i class="fas fa-chair fa-rotate-90" dmx-class:text-success="arrPlatinum.items.contains(varPlatinum2.value)"></i></div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="card-body custom-circle p-4 position-relative">
                <p class="text-center my-4 fs-4 fw-bolder">GOLD</p>
                <div is="dmx-repeat" class="d-flex justify-content-between" id="repeatGold1" dmx-bind:repeat="8">
                  ...
                  <div class="d-flex flex-column align-items-center">
                    <div class="col-auto d-flex">
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatGold1Childs1" dmx-bind:repeat="4">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrGold.addUniq(varGold1.value)" dmx-class:text-success="arrGold.items.contains(varGold1.value)"><i class="fas fa-chair fa-rotate-270"></i></div>
                      </div>
                      ...
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatGold1Childs2" dmx-bind:repeat="4">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrGold.addUniq(varGold2.value)" dmx-class:text-success="arrGold.items.contains(varGold2.value)"><i class="fas fa-chair fa-rotate-90"></i></div>
                      </div>
                    </div>
                    <dmx-value id="varGoldMiddle1" dmx-bind:value="'G'+(($index*9)+5)"></dmx-value>
                    <div class="tick-square" dmx-on:click="arrGold.addUniq(varGoldMiddle1.value)" dmx-class:text-success="arrGold.items.contains(varGoldMiddle1.value)"><i class="fas fa-chair fa-rotate-180"></i></div>
                  </div>
                </div>
                <div is="dmx-repeat" class="d-flex mt-3 justify-content-between" id="repeatGold2" dmx-bind:repeat="8">
                  ...
                  <div class="d-flex flex-column align-items-center">
                    <div class="col-auto d-flex">
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatGold2Childs1" dmx-bind:repeat="4">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrGold.addUniq(varGold3.value)" dmx-class:text-success="arrGold.items.contains(varGold3.value)"><i class="fas fa-chair fa-rotate-270"></i></div>
                      </div>
                      <div class="d-flex align-items-center">
                        <div class="card my-2 mx-1 border shadow-sm w-100">
                          <div class="card-body bg-light" style="height: 90px"> </div>
                      ...
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatGold2Childs2" dmx-bind:repeat="4">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrGold.addUniq(varGold4.value)" dmx-class:text-success="arrGold.items.contains(varGold4.value)"><i class="fas fa-chair fa-rotate-90"></i></div>
                      </div>
                    </div>
                    <dmx-value id="varGoldMiddle2" dmx-bind:value="'G'+((($index*9)+5)+72)"></dmx-value>
                    <div class="tick-square" dmx-on:click="arrGold.addUniq(varGoldMiddle2.value)" dmx-class:text-success="arrGold.items.contains(varGoldMiddle2.value)"><i class="fas fa-chair fa-rotate-180"></i></div>
                  </div>
                </div>
                <p class="text-center my-4 fs-4 fw-bolder">SILVER</p>
                <div is="dmx-repeat" class=" d-flex justify-content-between" id="repeatSilver1" dmx-bind:repeat="8">
                  ...
                  <div class="d-flex flex-column align-items-center">
                    <div class="col-auto d-flex">
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatSilver1Childs1" dmx-bind:repeat="9">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrSilver.addUniq(varSilver1.value)" dmx-class:text-success="arrSilver.items.contains(varSilver1.value)"><i class="fas fa-chair fa-rotate-270"></i></div>
                      </div>
                      <div class="d-flex align-items-center">
                        <div class="card my-2 mx-1 border shadow-sm w-100">
                      ...
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatSilver1Childs2" dmx-bind:repeat="9">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrSilver.addUniq(varSilver2.value)" dmx-class:text-success="arrSilver.items.contains(varSilver2.value)"><i class="fas fa-chair fa-rotate-90"></i></div>
                      </div>
                    </div>
                    <dmx-value id="varSilverMiddle1" dmx-bind:value="'S'+(($index*19)+10)"></dmx-value>
                    <div class="tick-square" dmx-on:click="arrSilver.addUniq(varSilverMiddle1.value)" dmx-class:text-success="arrSilver.items.contains(varSilverMiddle1.value)"><i class="fas fa-chair fa-rotate-180"></i></div>
                  </div>
                </div>
                <div is="dmx-repeat" class="mt-3 d-flex justify-content-between" id="repeatSilver2" dmx-bind:repeat="8">
                  ...
                  <div class="d-flex flex-column align-items-center">
                    <div class="col-auto d-flex">
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatSilver2Childs1" dmx-bind:repeat="9">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrSilver.addUniq(varSilver3.value)" dmx-class:text-success="arrSilver.items.contains(varSilver3.value)"><i class="fas fa-chair fa-rotate-270"></i></div>
                      </div>
                      <div class="d-flex align-items-center">
                        <div class="card my-2 mx-1 border shadow-sm w-100">
                          <div class="card-body bg-light" style="height: 200px"> </div>
                      ...
                      <div is="dmx-repeat" class="d-flex justify-content-between flex-column" id="repeatSilver2Childs2" dmx-bind:repeat="9">
                        ...
                        <div class="px-1 tick-square" dmx-on:click="arrSilver.addUniq(varSilver4.value)" dmx-class:text-success="arrSilver.items.contains(varSilver4.value)"><i class="fas fa-chair fa-rotate-90"></i></div>
                      </div>
                    </div>
                    <dmx-value id="varSilverMiddle2" dmx-bind:value="'S'+((($index*19)+10)+152)"></dmx-value>
                    <div class="tick-square" dmx-on:click="arrSilver.addUniq(varSilverMiddle2.value)" dmx-class:text-success="arrSilver.items.contains(varSilverMiddle2.value)"><i class="fas fa-chair fa-rotate-180"></i></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row">
          ...
          <div class="col d-flex justify-content-center">
            <div class="form-check d-flex align-items-center mb-3">
              <input class="form-check-input me-3" type="radio" name="meal_type" value="Veg Gujrati" id="radioGujrati">
              <label class="form-check-label mb-0" for="radioGujrati">
                Veg Gujrati
              </label>
            </div>
            <div class="form-check d-flex align-items-center mb-3 ms-4">
              <input class="form-check-input me-3" type="radio" name="meal_type" value="Regular Veg - Non Veg Meal" id="radioVegNonVeg">
